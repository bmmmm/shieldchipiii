/* shieldchipii — tiny DE/EN dictionary. */
(function () {
  "use strict";
  var DICT = {
    ...
    terminalNote: { de: "Terminal: cli/shieldchipii.js show '<Share-Link>'", en: "Terminal: cli/shieldchipii.js show '<share link>'" },
    ...
    importFileBroken: { de: "Datei konnte nicht gelesen werden — ist es ein shieldchipii-JSON-Export?", en: "Could not read the file — is it a shieldchipii JSON export?" },
